...
public class SignatureUtil {
    ...
    public static String generateSignature(Map<String, String> params, String secretKey)
        ...
        for (Map.Entry<String, String> entry : sortedParams.entrySet()) {
            ...
            query.append(entry.getKey().toLowerCase())
                 .append("=")
    ...
    public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        params.put("apiKey", "M3_9MJvYWqpGPxt0pgYYIUsh9pICv-TZ0-daZG597yp3QtyFlrqAxUzjtQGT43bQ");
        params.put("domainId", "f885e154-e0bf-4f25-92ef-6c5e446dca11");
        params.put("command", "listNetworks");
        params.put("userId", "someUserIdWillBeSkipped"); // Should be skipped

      String secretKey = "jHSYxkimKbnPiAdKtOAi0UbLUzXgipmZX8UdE-5qdCph17bISqfIERjr1_-VXkm9r4Q";

        String finalUrl = generateSignature(params, secretKey);
        System.out.println("\nFinal URL:");
        System.out.println(finalUrl);
    }
